...
class User:
    ...
    def get_certificate(self):
        if not self.certificate:
            raise ValueError("The certificate has not been received yet")
    ...
    def verify_data(self, data, signature, issuer_certificate):
        if not self.verify_certificate(issuer_certificate):
            print("Failed verify issuer certificate")
            return False
...
def main_ca():
    ...
    byte_array = b'sometextwrittingsometextwritting'

    signature = bob.sign_data(byte_array)
    
    if alice.verify_data(byte_array, signature, bob.get_certificate()):
        print("\nAlice verify byte array Bob")
    else:
        print("\nAlice failed verify byte array Bob")
